...
public class ExitManagerJumpGame : MonoBehaviour
{
    ...
    {
        InitPos.SetInitPos = new Vector3(9.06f, 4f, 30.5f);//나올 때 해당 미니씬 옆에 Player 위치시킴
        ...
        SliderMiniScene.NoRiverMiniScene_Num = 1;  //미니씬에서 나오고 해당 미니씬의 번호를 알려줌. JumpGame은 1
        ...
        Invoke("SetOffJumpGame", 0.5f);  //바로끄면 유니티 기본 배경보임으로 0.5초후에 시작하도록 .로딩프리팹이 나타나는데 시간이 좀 걸리므로 0.5초넣은것
    }
